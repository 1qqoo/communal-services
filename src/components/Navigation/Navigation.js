  ...
  return (
    <section
      className={`navigation ${
        windowScroll > 106 ? 'navigation_type_fixed' : ''
      }`}
    >
      <h1 className="navigation__title">
        "КОМФОРТЖИЛСЕРВИС" управляющая компания
      </h1>
      <nav className="navigation__box">
        ...
        <div className="navigation__container">
          ...
          <label
            htmlFor="menu"
            className="navigation__menu-container navigation__menu-container_type_first"
          >
        ...
        <div className="navigation__container2">
          ...
          <label
            htmlFor="menu2"
            className="navigation__menu-container navigation__menu-container_type_second"
          >
            Жителям <span>&#9205;</span>
          </label>
        ...
        <div className="navigation__container3">
          ...
          <label
            htmlFor="menu3"
            className="navigation__menu-container navigation__menu-container_type_third"
          >
